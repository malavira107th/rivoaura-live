...
const RULES = [
  ...
  },
  {
    ...
    body: "While hosts moderate their own parties, the Rivoaura Live team monitors the platform for serious violations. Repeated reports against a user across multiple parties may result in a permanent platform ban. Use the Report button if you see something that crosses the line."
  }
];
        ...
        <div className="container max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-muted-foreground mb-10 max-w-lg">
              Rivoaura Live is a community-driven platform. These guidelines apply to everyone — hosts, speakers, and listeners alike.
            </p>

 ...
 * Design: Stadium Noir
 * Clear, specific terms for Rivoaura Live
 */
            ...
            <div className="space-y-8">
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 mt-4">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Rivoaura Live is a <strong className="text-foreground">second-screen companion service</strong>. We do not broadcast, stream, rebroadcast, or provide access to any live cricket match footage, video, or audio commentary. Users must have their own subscription to an official broadcaster or licensed streaming provider in their region to watch the actual match. Our platform provides the social experience alongside the match — not the match itself.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                  ...
                  <li>Notify us immediately at <a href="mailto:support@rivoauralive.com" className="text-primary hover:underline">support@rivoauralive.com</a> if you suspect unauthorized access to your account.</li>
                </ul>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                  ...
                  <li><strong className="text-foreground">Not charge participants.</strong> Rivoaura Live is a free platform. You may not charge users to join your party or solicit payments through the Platform.</li>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                  ...
                  <li>Impersonating other users, public figures, or Rivoaura Live staff.</li>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Rivoaura Live is currently <strong className="text-foreground">100% free</strong> for all users — both hosting and joining parties. We may introduce optional premium features in the future. If we do, we will clearly communicate pricing before you are asked to pay anything. Free features available today will remain free.
                </p>
              </div>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                  <strong className="text-foreground">By you:</strong> You can request deletion of your account at any time by emailing <a href="mailto:support@rivoauralive.com" className="text-primary hover:underline">support@rivoauralive.com</a>. Upon deletion, your personal data will be removed from our active systems within 30 days. Events you created will be removed or anonymized.
                </p>
                <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <div className="mt-3 bg-background/60 rounded-lg p-4">
                  <p className="text-sm text-foreground font-semibold">Rivoaura Live — Legal</p>
                  <p className="text-sm text-muted-foreground mt-1">Email: <a href="mailto:legal@rivoauralive.com" className="text-primary hover:underline">legal@rivoauralive.com</a></p>

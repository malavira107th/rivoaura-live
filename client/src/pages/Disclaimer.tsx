 ...
 * DISCLAIMER PAGE
 * Design: Stadium Noir
 * Clear, specific disclaimers for Rivoaura Live
 */
            ...
            <div className="space-y-8">
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                  This is the most important thing to understand about Rivoaura Live:
                </p>
                <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4 mb-4">
                  <p className="text-sm text-red-400 font-semibold">
                    Rivoaura Live does not broadcast, stream, rebroadcast, host, link to, or provide access to any live cricket match footage, video, audio commentary, or any other copyrighted broadcast content — in any form.
                  </p>
                </div>
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  To watch any cricket match, you must have your own legal subscription to an official broadcaster or licensed streaming provider in your region. Rivoaura Live has no relationship with any broadcasting or streaming services.
                </p>
              </div>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                  Watch parties on this platform are created and managed entirely by individual users (the "hosts"). Rivoaura Live the company does not create, curate, endorse, or moderate the content of individual parties. Specifically:
                </p>
                <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                  <li><strong className="text-foreground">Opinions expressed</strong> by hosts and participants in audio rooms and chat rooms are their own and do not represent the views of Rivoaura Live.</li>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                  Rivoaura Live <strong className="text-foreground">strictly prohibits</strong> the following activities on the Platform:
                </p>
                <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Users may share links to external websites within chat rooms or party descriptions. Rivoaura Live does not endorse, verify, or take responsibility for any third-party content, websites, or services linked from the Platform. Clicking on external links is at your own risk. We strongly advise against clicking on links from unknown users.
                </p>
              </div>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                  To the maximum extent permitted by applicable law, Rivoaura Live, its founders, team members, and affiliates shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform, including but not limited to: loss of data, loss of goodwill, emotional distress, or any damages resulting from interactions with other users. Since the Platform is free, our maximum aggregate liability for any claim is zero ($0 / ₹0).
                </p>
              </div>
              ...
              <div className="bg-card border border-border/60 rounded-xl p-6">
                ...
                <div className="mt-3 bg-background/60 rounded-lg p-4">
                  <p className="text-sm text-foreground font-semibold">Rivoaura Live — Trust & Safety</p>
                  <p className="text-sm text-muted-foreground mt-1">General: <a href="mailto:support@rivoauralive.com" className="text-primary hover:underline">support@rivoauralive.com</a></p>
                  <p className="text-sm text-muted-foreground">Legal & Copyright: <a href="mailto:legal@rivoauralive.com" className="text-primary hover:underline">legal@rivoauralive.com</a></p>
                  <p className="text-sm text-muted-foreground">Privacy: <a href="mailto:privacy@rivoauralive.com" className="text-primary hover:underline">privacy@rivoauralive.com</a></p>
                  <p className="text-sm text-muted-foreground">Contact Form: <a href="/contact" className="text-primary hover:underline">rivoauralive.com/contact</a></p>
                </div>
              </div>
